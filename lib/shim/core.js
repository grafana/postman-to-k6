...
/* Scoped interface */
function enterRequest (method, address, body, options) {
  state.request = true
  if (method !== undef) {
    store.request.method = method.toUpperCase()
  }
  surface.request = new Dict(store.request)
...
function exitRequest () {
  ...
  store.request.method = null
  surface.request = new Dict()
  exposePm()
  Object.assign(global, {
...
Object.defineProperties(global, {
  ...
  request: {
    get () {
      return (state.request ? surface.request : undef)
    }
  }
})
Object.assign(global, {
