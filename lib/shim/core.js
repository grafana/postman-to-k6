...
const postman = Object.freeze({
  ...
  [Extend]: {
    AssertionError: null,
    expect () {
      throw new Error('To use pm.expect import "./bundle/shim/expect.js"')
    },
    jsonSchema () {
      throw new Error(
        'To use JSON schema import "./bundle/shim/jsonSchema.js"'
      )
    },
    jsonSchemaNot () {
      throw new Error(
        'To use JSON schema impot "./bundle/shim/jsonSchema.js"'
      )
    },
    module: {}
  }
...
function xml2Json (xml) {
  throw new Error('To use xml2Json import ./bundle/shim/xml2Json.js')
}
  ...
  switch (id) {
    ...
    case 'crypto-js':
      if (postman[Extend].module[id]) {
        ...
        throw new Error(`To use module ${id} import ./bundle/shim/${id}.js`)
      }
    default:
      throw new Error(
