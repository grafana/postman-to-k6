...
const postman = Object.freeze({
  ...
  [Extend]: {
    AssertionError: null,
    expect () {
      throw new Error('To use pm.expect import "./expect.js"')
    },
    jsonSchema () {
      throw new Error('To use JSON schema import "./jsonSchema.js"')
    },
    jsonSchemaNot () {
      throw new Error('To use JSON schema impot "./jsonSchema.js"')
    },
    module: {}
  }
})
...
function require (id) {
  switch (id) {
    case 'lodash':
      if (postman[Extend].module.lodash) {
        return postman[Extend].module.lodash
      } else {
        throw new Error('To use module lodash import ./shim/lodash.js')
      }
    default:
      throw new Error(
