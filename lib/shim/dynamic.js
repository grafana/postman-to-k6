...
const LOCALES = ['af', 'am', 'an', 'ar', 'ast', 'az', 'be', 'bg', 'bh', 'bn', 'br', 'bs', 'ca', 'ceb', 'ckb', 'co', 'cs',
...
const dynamicGenerators = {
  ...
  $randomWords: {
    ...
    generator: function () {
      var words = []
      var count = faker.random.number({ min: 2, max: 5 })
      var i
...
// Build a regex matching the dynamicGenerators
...
const dynamicGeneratorsRegex = function() {
  ...
  // Remove the trailing '|'
  generatorRegexString = generatorRegexString.slice(0,-1);

  // Escape the special regex characters we can find in generator name. Method inspired by: 
  // https://stackoverflow.com/questions/3561493/is-there-a-regexp-escape-function-in-javascript/3561711#3561711
  generatorRegexString = generatorRegexString.replace(/[${}]/g, '\\$&');
