...
test('global', async t => {
  const result = await convertFile('test/material/2/var-global.json', {
...
test('collection', async t => {
  const result = await convertFile('test/material/2/var-collection.json')
  t.is(result, `// Auto-generated by the Load Impact converter
...
test('environment', async t => {
  const result = await convertFile('test/material/2/var-environment.json', {
...
test('data json', async t => {
  const result = await convertFile('test/material/2/var-data-json.json', {
...
test('data csv', async t => {
  const result = await convertFile('test/material/2/var-data-csv.json', {
...
test('address start', async t => {
  const result = await convertFile('test/material/2/var-address-start.json')
  t.is(result, `// Auto-generated by the Load Impact converter
